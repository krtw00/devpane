...
export const AgentEventSchema = z.discriminatedUnion("type", [
  ...
  z.object({ type: z.literal("flow.wip_exceeded"), openPrs: z.number(), limit: z.number() }),
  z.object({ type: z.literal("flow.jidoka_stop"), consecutiveFailures: z.number(), limit: z.number() }),
])
